...
// ─── Game Config ────────────────────────────────────────────────
export const BLINK_THRESHOLD = 0.21;  // blendshape score 0→1 (eyes closed > threshold = blink)
export const BLINK_COOLDOWN = 100;    // ms between registered blinks (detection)
export const BLINK_FRAMES = 1;        // consecutive frames above threshold to register a blink
